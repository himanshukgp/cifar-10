...
def train(**keywords):
    ...
    **keywords:
    ...
    for epoch in range(keywords['num_epochs']):
        total_batch_training = int(keywords['data']['images_train'].shape[0] / keywords['batch_size'])
        ...
        for batch_num in range(total_batch_training):
            ...
            train_batch_data, train_batch_label = keywords['data']['images_train'][start_idx:end_idx], keywords[
                                                                                                        'data']['labels_train'][
                                                                                                    start_idx:end_idx]
        ...
        if keywords['online_test']:
            ...
            test_accuracy_epoch, test_summaries = keywords['sess'].run(
                ...
                feed_dict={keywords['tensors']['image_place']: keywords['data']['images_test'],
                           keywords['tensors'][
                               'label_place']: keywords['data']['labels_test'],
                           keywords['tensors'][
                               'dropout_param']: 1.})
